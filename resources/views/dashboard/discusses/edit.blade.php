...
@section('body')
    {{-- Main Form --}}
    <form action="/dashboard/discusses/{{ $discuss->slug }}" method="POST" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input id="body" type="hidden" name="body" value="{{ old('body', $discuss->body) }}" @error('body') class="is-invalid" @enderror
