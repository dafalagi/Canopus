...
<div class="flex">   
    ...
    {{-- card komen --}}
    <div>
        <div class="relative bg-mainclr ml-10 mt-4 grid grid-cols-1 max-w-1xl rounded-md py-2 px-4">
        {{-- ini dropdown abawah --}}  
        ...
        <div id="dropdown2" class=" hidden z-10 rounded divide-y shadow" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(246.667px, 70px, 0px);">
            <ul class="text-sm text-white bg-mainclr rounded-md" aria-labelledby="dropdownDefault">
              <li>
                <form action="/modaleditkomentar" method="POST" class="block py-2 px-4 hover:bg-thirdclr hover:rounded-t-md hover:text-secondaryclr">
                    ...
                    <input type="submit" name="submit" value="Edit Komentar" class="ml-6">
                </form>            
              </li>
              <li>
                <form action="/validasihapuskomentar" method="POST" class="block py-2 px-4 hover:bg-thirdclr hover:text-secondaryclr">
                    ...
                    <input type="submit" name="submit" value="Hapus Komentar" class="ml-6">
                </form>            
              </li>
              <li>
                <form action="/modalreport" method="POST" class="block py-2 px-4 hover:bg-thirdclr hover:rounded-b-md hover:text-secondaryclr">
                    <svg class="w-4 absolute fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM232 152C232 138.8 242.8 128 256 128s24 10.75 24 24v128c0 13.25-10.75 24-24 24S232 293.3 232 280V152zM256 400c-17.36 0-31.44-14.08-31.44-31.44c0-17.36 14.07-31.44 31.44-31.44s31.44 14.08 31.44 31.44C287.4 385.9 273.4 400 256 400z"/></svg>
                    <input type="submit" name="submit" value="Laporkan Komentar" class="ml-6">
                </form>
              </li>
            </ul>
        </div>        
        <h1 class="font-bold text-sm text-white">Orang lagi komen</h1>
        <article class="text-white text-xs pt-1">lv 2 Lorem ipsum dolor sit amet consectetur adipisicing Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae, facilis.</article>
        </div>
