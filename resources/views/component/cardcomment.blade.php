...
<div class="w-fit">
    ...
    {{-- ini dropdown abawah --}}  
    <button id="menu-btn1" data-dropdown-toggle="dropdown1" class="absolute right-0 top-0 text-white hover:bg-thirdclr font-medium rounded-md text-sm px-2.5 py-2.5 text-center inline-flex items-center " type="button">
    ...
    <article class="text-white text-xs pt-1">lv 1lorem30</article>
    </div>
