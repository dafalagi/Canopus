<!-- Main modal -->
<div id="modalFailedCT" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-3 w-xl md:h-auto">
        ...
        <div>
            ...
            <div class="w-96 mt-3 mr-24 ml-24 text-white text-center text-sm">
                Komentar kamu gagal dihapus, silakan lakukan kembali 
            </div>
            <!-- Modal footer -->
            <div class="flex items-center p-12 space-x-2 border-gray-200 dark:border-gray-600">
            <button data-modal-toggle="modalFailedCT" type="button" class="mx-auto bg-[#FF9119] text-white hover:bg-gray-100 rounded-lg border border-gray-200 text-xl font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600">Tutup</button>
        </div>
        </div>
    </div>
</div>
