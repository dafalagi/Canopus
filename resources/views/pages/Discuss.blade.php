...
<body class="font-poppins">
  ...
  @include('.component.navbar')
    ...
    <button id="menu-btn1" data-dropdown-toggle="dropdown1" class="absolute right-24 top-5 text-white hover:bg-mainclr font-medium rounded-lg text-sm px-2.5 py-2.5 text-center inline-flex items-center " type="button"><svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
    ...
    <div id="dropdown1" class=" hidden z-10 rounded divide-y shadow" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(246.667px, 70px, 0px);">
        <ul class="text-sm text-white bg-mainclr rounded-md" aria-labelledby="dropdownDefault">
          ...
          <li>
            <a href="#" class="block hover:rounded-b-md py-2 px-4 hover:bg-thirdclr hover:text-secondaryclr">
              <svg class="w-4 absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM232 152C232 138.8 242.8 128 256 128s24 10.75 24 24v128c0 13.25-10.75 24-24 24S232 293.3 232 280V152zM256 400c-17.36 0-31.44-14.08-31.44-31.44c0-17.36 14.07-31.44 31.44-31.44s31.44 14.08 31.44 31.44C287.4 385.9 273.4 400 256 400z"/></svg>
              <span class="ml-6">Laporkan Diskusi</span></a>
          </li>
        </ul>
    </div>        
    ...
    <h1 class="font-bold text-3xl text-white">{{ $discuss->title }}</h1>
      ...
      <img 
        ...
        alt=""/>
      <p class="text-sm ml-10 text-white mb-3">Di unggah oleh <span><span class="text-secondaryclr">{{ $discuss->user->username }}</span></span> | <span>{{ $discuss->created_at->diffForHumans() }}</span></p>
      </div>
      ...
      <button class="mr-1 mt-2 text-white hover:text-secondaryclr">
        ...
        <span class="text-white mr-3 mt-2 text-md">{{ count($discuss->likes) }}</span>
      <a href="">
        <img 
    ...
    <div>       
    {{-- ini field komentar --}}
    <div class="bg-mainclr py-2 px-3 rounded-full mt-5">
        <p class="opacity-25 text-white">Tulis komentar...</p>
    </div>
      ...
      <a href="#">
        ...
        src="/imgs/bengeutaripkotak.jpeg">
      </a>
      {{-- card komen --}}
      <div class="relative bg-mainclr ml-10 mt-4 grid grid-cols-1 max-w-2xl rounded-md py-2 px-4">
        {{-- ini dropdown abawah --}}  
        <button id="menu-btn2" data-dropdown-toggle="dropdown2" class="absolute right-0 top-0 text-white hover:bg-thirdclr font-medium rounded-md text-sm px-2.5 py-2.5 text-center inline-flex items-center " type="button"><svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
        <!-- Dropdown menu bawah -->
        <div id="dropdown2" class=" hidden z-10 rounded divide-y shadow" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(246.667px, 70px, 0px);">
            <ul class="text-sm text-white bg-mainclr rounded-md" aria-labelledby="dropdownDefault">
              <li>
                <a href="#" class="hover:fill-white block hover:rounded-t-md py-2 px-4 hover:bg-thirdclr hover:text-secondaryclr">
                  <svg class="w-4 absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M135.2 17.69C140.6 6.848 151.7 0 163.8 0H284.2C296.3 0 307.4 6.848 312.8 17.69L320 32H416C433.7 32 448 46.33 448 64C448 81.67 433.7 96 416 96H32C14.33 96 0 81.67 0 64C0 46.33 14.33 32 32 32H128L135.2 17.69zM394.8 466.1C393.2 492.3 372.3 512 346.9 512H101.1C75.75 512 54.77 492.3 53.19 466.1L31.1 128H416L394.8 466.1z"/></svg>
              ...
              <li>
                <a href="#" class="hover:fill-white block hover:rounded-b-md py-2 px-4 hover:bg-thirdclr hover:text-secondaryclr">
                  <svg class="w-4 absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256s256-114.6 256-256S397.4 0 256 0zM232 152C232 138.8 242.8 128 256 128s24 10.75 24 24v128c0 13.25-10.75 24-24 24S232 293.3 232 280V152zM256 400c-17.36 0-31.44-14.08-31.44-31.44c0-17.36 14.07-31.44 31.44-31.44s31.44 14.08 31.44 31.44C287.4 385.9 273.4 400 256 400z"/></svg>
      ...
      {{-- sesudah user menekan tombol lope --}}
      <svg class="w-3 mt-1.5 absolute fill-red-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M0 190.9V185.1C0 115.2 50.52 55.58 119.4 44.1C164.1 36.51 211.4 51.37 244 84.02L256 96L267.1 84.02C300.6 51.37 347 36.51 392.6 44.1C461.5 55.58 512 115.2 512 185.1V190.9C512 232.4 494.8 272.1 464.4 300.4L283.7 469.1C276.2 476.1 266.3 480 256 480C245.7 480 235.8 476.1 228.3 469.1L47.59 300.4C17.23 272.1 .0003 232.4 .0003 190.9L0 190.9z"/></svg>  
      <button class="text-white hover:text-secondaryclr">
        <span class="ml-5 mt-1.5 text-xs ">Like</span>
      </button>
        <span class="text-white mt-1.5 pl-1 pr-1 text-xs">69</span>
      <button>
        <span class="text-xs pl-2 md:pl-5 text-white hover:text-secondaryclr">Balasan</span>
      </button>
        <span class="text-white mt-1.5 pl-1 pr-1 text-xs">69</span>
      ...
      {{-- card komen balasan 1 --}}
      {{-- pp imsan balasan 1 --}}
      <a href="#">
        <img
        class="w-8 mt-3 ml-10 absolute rounded-full"
        src="/imgs/aripmanusiaswag.jfif">
      </a>
      <div class="relative bg-mainclr ml-20 mt-3 grid grid-cols-1 max-w-lg rounded-md py-2 px-4">
        {{-- ini dropdown bawah balasan --}}  
        <button id="menu-btn3" data-dropdown-toggle="dropdown3" class="absolute right-0 top-0 text-white hover:bg-thirdclr font-medium rounded-md text-sm px-2.5 py-2.5 text-center inline-flex items-center " type="button"><svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
        <!-- Dropdown menu bawah balasan -->
      ...
      {{-- card komen balasan 2 --}}
      {{-- pp imsan balasan 2 --}}
      <a href="#">
        <img
        class="w-8 mt-3 ml-20 absolute rounded-full"
        src="/imgs/p-arif.png">
      </a>
      <div class="relative bg-mainclr ml-32 mt-3 grid grid-cols-1 max-w-md rounded-md py-2 px-4">
        {{-- ini dropdown bawah balasan --}}  
        <button id="menu-btn2" data-dropdown-toggle="dropdown2" class="absolute right-0 top-0 text-white hover:bg-thirdclr font-medium rounded-md text-sm px-2.5 py-2.5 text-center inline-flex items-center " type="button"><svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
        <!-- Dropdown menu bawah balasan -->
        <div id="dropdown2" class=" hidden z-10 rounded divide-y shadow" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(246.667px, 70px, 0px);">
